...
const PRIMITIVE_TYPES = new Set(['string', 'number', 'boolean', 'bigint', 'symbol', 'undefined', 'null', 'any', 'unknown', 'never', 'void', 'object'])
...
function collectNamedRefsFromNode(
...
interface RelatedUnion { kind: 'union'; values: string[]; own?: boolean }
interface RelatedAlias { kind: 'alias'; type: string; own?: boolean }
interface RelatedInterface { kind: 'interface'; props: Record<string, PropDef>; own?: boolean }
type RelatedType = RelatedUnion | RelatedAlias | RelatedInterface
...
function propsTypeNameFromSignature(
  checker: ts.TypeChecker,
