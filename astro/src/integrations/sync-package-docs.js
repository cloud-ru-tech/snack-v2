...
// to astro/src/content/docs/components/ for Starlight
...
function transformImportPaths(content, pkgName) {
  ...
  // Transform component imports from astro
  content = content.replace(
    /from\s+['"]\.\.\/\.\.\/\.\.\/astro\/src\/components\//g,
    "from '../../../../../components/"
  );
...
async function syncPackageLocale(
  ...
  for (const docFile of docFiles) {
    ...
    // For locale structure: packages/*/docs/{locale}/../../../../astro/src/components/
    // For legacy structure: packages/*/docs/../../../../astro/src/components/
    // Both should point to: ../../../../../components/
    const exampleComponentPatterns = [
      {
        from: /from\s+['"]\.\.\/\.\.\/\.\.\/\.\.\/\.\.\/astro\/src\/components\/mdx['"]/g,
    ...
    const componentImportPatterns = [
      {
        from: /from\s+['"]\.\.\/\.\.\/\.\.\/\.\.\/\.\.\/astro\/src\/components\/StorybookIframe\.astro['"]/g,
      ...
      {
        from: /from\s+['"]\.\.\/\.\.\/\.\.\/\.\.\/\.\.\/astro\/src\/components\/Changelog\.astro['"]/g,
      ...
      {
        from: /from\s+['"]\.\.\/\.\.\/\.\.\/\.\.\/\.\.\/astro\/src\/components\/VersionSwitcher\.astro['"]/g,
      ...
      {
        from: /from\s+['"]\.\.\/\.\.\/\.\.\/\.\.\/\.\.\/astro\/src\/components\/LlmLink\.astro['"]/g,
