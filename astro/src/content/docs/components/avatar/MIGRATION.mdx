...
description: Migration instructions for avatar package versions
version: "0.1.0"
order: 998
---
...
This guide provides instructions for LLM agents to migrate between versions of the `avatar` package.
