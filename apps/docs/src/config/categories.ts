...
export const CATEGORIES_BY_DOMAIN: Readonly<Record<string, readonly Category[]>> = {
  ...
  'uikit-product': [
    ...
    },
    {
      ...
      label: 'Overlays',
      description:
        'Продуктовые всплывающие поверхности: предопределённые модальные окна (удаление, отзыв, release notes), онбординг-тур.',
      packages: ['uikit-product-modal-predefined', 'uikit-product-welcome-tour'],
    },
    {
      id: 'feedback',
      label: 'Feedback',
  ...
  ai: [
    {
      ...
      packages: ['ai-card', 'ai-suggestion', 'ai-field-banner', 'ai-field-notice', 'ai-field-request', 'ai-queue'],
    },
    {
      id: 'ai-process',
