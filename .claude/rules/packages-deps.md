...
Все зависимости — **только строгие версии**. Никаких `^`, `~`, `>=`, `*` или других диапазонов.
...
Workspace-ссылки допускаются как `"workspace:*"` — это не версия, а специальный протокол pnpm.
