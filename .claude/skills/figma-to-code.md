...
Допустимые значения `data-state` (camelCase, только из этого списка): `regularBackground`, `regularBorder`, `activatedBackground`, `activatedBorder`, `onColorBackground`, `onAccentBackground`.
