...
const WIDE_FIELDS: WideField[] = [
  {
    ...
    mode: COLUMN_SETTINGS_MODE.DefaultVisible,
    size: 170,
  },
  {
    id: 'team',
  ...
  { id: 'country', label: 'Страна', value: () => 'Россия', mode: COLUMN_SETTINGS_MODE.DefaultHidden, size: 130 },
  {
    id: 'region',
    label: 'Регион',
    value: u => pickBy(REGIONS, u.id, 3),
    mode: COLUMN_SETTINGS_MODE.DefaultHidden,
    size: 120,
  },
  { id: 'plan', label: 'Тариф', value: u => pickBy(PLANS, u.id), mode: COLUMN_SETTINGS_MODE.DefaultVisible, size: 120 },
  {
    id: 'seats',
    label: 'Лицензий',
  ...
  columns.push(
    ...
    },
    {
      ...
      ...(withCopyColumn
        ...
        : {}),
      ...(withColumnSettings ? { columnSettings: { label: 'Email', mode: COLUMN_SETTINGS_MODE.DefaultVisible } } : {}),
    },
    {
      accessorKey: 'role',
      header: 'Роль',
      enableSorting: true,
      size: 140,
      ...(withColumnSettings ? { columnSettings: { label: 'Роль', mode: COLUMN_SETTINGS_MODE.DefaultHidden } } : {}),
    },
    {
      accessorKey: 'amount',
      header: 'Баланс',
      ...
      ...(withColumnSettings ? { columnSettings: { label: 'Баланс', mode: COLUMN_SETTINGS_MODE.Locked } } : {}),
    },
  );
