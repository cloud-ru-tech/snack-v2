...
export const entitiesColumnDefinitions: ColumnDefinition<StoryEntity>[] = [
  ...
  }),
  {
    ...
    accessorKey: 'name',
    header: 'Name',
    columnSettings: { label: 'Name', mode: 'defaultTrue' },
    enableSorting: true,
  },
  {
    id: 'owner',
    accessorKey: 'owner',
    header: 'Owner',
    columnSettings: { label: 'Owner', mode: 'defaultTrue' },
    enableSorting: true,
  },
  {
    id: 'region',
    accessorKey: 'region',
    header: 'Region',
    columnSettings: { label: 'Region', mode: 'defaultTrue' },
    enableSorting: true,
  },
  {
    id: 'service',
    accessorKey: 'service',
    header: 'Service',
    columnSettings: { label: 'Service', mode: 'defaultTrue' },
    enableSorting: true,
  },
  {
    id: 'createdAt',
    ...
    header: 'Created at',
    columnSettings: { label: 'Created at', mode: 'defaultTrue' },
    enableSorting: true,
  },
  getRowActionsColumnDef({
    pinned: true,
