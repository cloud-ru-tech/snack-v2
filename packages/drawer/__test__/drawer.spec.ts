...
test.describe('Drawer', () => {
  ...
  test('should open nested drawer from footer and close it while parent stays open', async ({
    gotoStory,
    getByTestId,
    page,
  }) => {
    ...
    await page.getByRole('button', { name: NESTED_DRAWER_OPEN_LABEL }).click();
    ...
    await page.getByRole('button', { name: NESTED_DRAWER_CLOSE_LABEL }).click();
    await expect(nestedRoot).not.toBeAttached();
