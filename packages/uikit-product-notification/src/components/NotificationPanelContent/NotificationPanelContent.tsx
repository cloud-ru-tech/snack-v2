...
export type NotificationPanelContentProps = WithSupportProps<{
  /** Заголовок панели */
  title: string;
  ...
  /** Состояние загрузки */
  loading?: boolean;
  /** Контент для отрисовки (e.g NotificationCard | NotificationPanelContent.Blank) */
  content?: ReactNode;
...
/** Контент панели уведомлений (header + scrollable body + footer). Помещается в обёртку `NotificationPanel`. */
...
export namespace NotificationPanelContent {
