...
const meta: Meta<typeof AiCard> = {
  ...
  argTypes: {
    title: { control: 'text', description: 'Заголовок карточки.' },
    children: { control: 'text', description: 'Контент карточки.' },
    checked: { control: 'boolean', description: 'Selected-состояние карточки (controlled).' },
    disabled: { control: 'boolean', description: 'Disabled-состояние.' },
