...
<Example title='С фоном' description='background — визуально выделяет строку.' code={WithBackgroundSrc}>
...
## Figma
<FigmaEmbed node={figmaNode('status')} height={480} title='Status в Figma (Snack UI Kit)' />
