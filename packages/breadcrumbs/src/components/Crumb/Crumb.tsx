...
export const Crumb = memo(function Crumb({
  ...
  const isLabelEllipsis = hidden && labelProp.length > ELLIPSIS_LABEL_LENGTH;
  const label =
    isLabelEllipsis && renderMode === ITEM_RENDER_MODE.Ellipsis ? `${labelProp.substring(0, 4)}...` : labelProp;
