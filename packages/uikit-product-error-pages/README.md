...
- Шире `1023px` — две колонки: контент слева, иллюстрация справа внизу.
- `768–1023px` — одна колонка, иллюстрация под контентом.
- До `767px` — одна колонка, иллюстрация скрыта, кнопки на всю ширину и прижаты к низу.
...
- `PageUnavailable` — сервис недоступен. Кнопка «На главную», ссылка «Назад».
