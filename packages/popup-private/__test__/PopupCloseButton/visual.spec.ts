...
import { buildStoryOptions, POPUP_CLOSE_BUTTON_STORIES } from './helpers';

test.describe('PopupCloseButton — visual regression', () => {
  ...
  test('visual matrix', async ({ page, gotoStory, waitForFonts }) => {
    await gotoStory(buildStoryOptions(undefined, POPUP_CLOSE_BUTTON_STORIES.visualMatrix));
    await waitForFonts();
