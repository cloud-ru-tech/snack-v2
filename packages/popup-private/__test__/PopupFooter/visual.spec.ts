...
import { buildStoryOptions, POPUP_FOOTER_STORIES } from './helpers';

test.describe('PopupFooter — visual regression', () => {
  ...
  test('visual matrix', async ({ page, gotoStory, waitForFonts }) => {
    await gotoStory(buildStoryOptions(undefined, POPUP_FOOTER_STORIES.visualMatrix));
    await waitForFonts();
