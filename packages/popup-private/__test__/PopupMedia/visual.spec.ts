...
import { buildStoryOptions, POPUP_MEDIA_STORIES } from './helpers';

test.describe('PopupMedia — visual regression', () => {
  ...
  test('visual matrix', async ({ page, gotoStory, waitForFonts }) => {
    await gotoStory(buildStoryOptions(undefined, POPUP_MEDIA_STORIES.visualMatrix));
    await waitForFonts();
