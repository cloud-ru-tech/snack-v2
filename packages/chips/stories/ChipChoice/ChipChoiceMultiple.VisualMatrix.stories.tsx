    ...
    <div className={styles.matrix}>
        ...
        rows={[
          ...
          },
          {
            ...
            cells: SIZES.map(size => (
              <ChipChoice.Multiple key={size} label='Filter' size={size} options={OPTIONS} icon={CHIP_CHOICE_ICON} />
            )),
          },
          {
      ...
      <StoryTable
        ...
        rows={CHIP_CHOICE_STATE_ROWS.map(({ key, extra }) => ({
          variantLabel: key,
          cells: SIZES.map(size => (
            <ChipChoice.Multiple key={size} label='Filter' size={size} options={OPTIONS} {...extra} />
          )),
        }))}
      />
    </div>
