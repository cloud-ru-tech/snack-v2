...
import { Typography, VARIANT, SIZE, WEIGHT } from '../src';
import {
  ExampleContainer,
  ExampleRow,
  ExampleGrid,
...
Для просмотра всех доступных комбинаций используйте story **Variants Table** в Storybook. Таблица показывает все варианты типографики в структурированном виде с четкими границами и заголовками, что упрощает сравнение стилей.

<StorybookIframe storyId="components-typography--variants-table" showControls={false} height="800px" />
