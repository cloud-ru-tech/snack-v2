...
export const VariantsTable: Story = {
  tags: ['dev', 'autodocs'],
  render: () => {
    ...
    return (
      <div className={styles.container}>
        {weights.map((weight, weightIndex) => (
          <div key={weight}>
            {weightIndex > 0 && <div className={styles.sectionSpacer} />}
            <Typography
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Таблица всех вариантов типографики: варианты × размеры × начертания. Используйте эту таблицу для быстрого сравнения всех доступных стилей типографики.',
      },
    },
  },
};
