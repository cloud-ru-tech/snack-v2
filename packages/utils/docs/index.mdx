...
title: Utils
package: '@ds/utils'
description: Хуки и хелперы для React-компонентов — controlled/uncontrolled, дебаунс, свайпы, модалки, персист данных, пропы и SSR.
order: 5
---
...
> Оформление (тема, бренд, плотность, цветовая схема) переехало в `@ds/theme` — см. [Theme](/components/theme) и паттерн [Оформление](/patterns/theme).
