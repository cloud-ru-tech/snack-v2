---
title: Context Kit
package: '@ds/context-kit'
description: Основа всех сквозных провайдеров дизайн-системы — версионно-устойчивый React-контекст-синглтон поверх useSyncExternalStore, безопасный для SSR и микрофронтов.
order: 92
---
