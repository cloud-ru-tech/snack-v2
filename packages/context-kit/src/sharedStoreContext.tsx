...
/**
 * Внешний стор в формате `useSyncExternalStore`. Источником может быть что угодно: RxJS-subject
 * в контейнере single-spa, redux/zustand, статичное значение. React подписывается на него и
 ...
 * - в браузере (single-spa) обновление внешнего стора реактивно передаётся всем компонентам
