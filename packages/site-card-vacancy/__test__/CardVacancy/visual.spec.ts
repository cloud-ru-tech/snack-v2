...
import { buildStoryOptions, CARD_VACANCY_STORIES, TEST_IDS } from './helpers';

test.describe('CardVacancy — visual regression', () => {
  ...
  test('visual-matrix', async ({ page, gotoStory, waitForFonts }) => {
    await gotoStory(buildStoryOptions(undefined, CARD_VACANCY_STORIES.visualMatrix));
    await waitForFonts();
