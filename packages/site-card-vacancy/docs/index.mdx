...
<Example
  ...
  content='appearance="neutral" (по умолчанию): href + title + description'
  code={NeutralSrc}
>
...
<Example
  ...
  content='appearance="primary": акцентный фон с декоративным паттерном'
  code={PrimarySrc}
>
...
<Example
  ...
  content='mobile: компактнее — меньше высота и типографика'
  code={MobileSrc}
>
...
<Example
  ...
  content="target='_blank' → rel='noopener noreferrer' автоматически"
  code={ExternalSrc}
>
...
<Example
  ...
  content="as='button' с onClick — для онклик-сценариев без перехода"
  code={PolymorphicSrc}
>
