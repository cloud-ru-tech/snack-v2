...
const modalPlaygroundStory = {
  name: 'modal-modal' as const,
  story: 'playground' as const,
};

function modalGotoOptions(props: Record<string, unknown> = {}) {
  return {
    ...modalPlaygroundStory,
    props,
  };
}
...
test.describe('Modal', () => {
  ...
  test('Focus trap: initial focus on dialog container, Tab cycles footer and close, restores focus after Escape', async ({
    ...
    // ButtonGroup: secondary → primary в DOM; затем кнопка закрытия в ModalCustom.
