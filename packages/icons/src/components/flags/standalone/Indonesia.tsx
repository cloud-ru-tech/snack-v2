...
const IndonesiaSVG = createStandaloneIcon({
  testId: '-indonesia',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Indonesia_svg__a)'>
        <mask id='Indonesia_svg__b' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <path fill='#E70011' d='M0 0h24v9H0z' />
        <path fill='#fff' d='M0 9h24v9H0z' />
      </g>
      <path
        fill='#DEE1E8'
