...
const ItalySVG = createStandaloneIcon({
  testId: '-italy',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Italy_svg__a)'>
        <mask id='Italy_svg__c' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <g clipPath='url(#Italy_svg__b)'>
          <path fill='#fff' d='M0 0h24v18H0z' />
          <path fill='#009246' fillRule='evenodd' d='M0 0h8v18H0z' clipRule='evenodd' />
          <path fill='#CE2B37' fillRule='evenodd' d='M16 0h8v18h-8z' clipRule='evenodd' />
        </g>
      </g>
      <path
        fill='#DEE1E8'
