...
const BeninSVG = createStandaloneIcon({
  testId: '-benin',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Benin_svg__a)'>
        <mask id='Benin_svg__b' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <path fill='#319400' fillRule='evenodd' d='M0 0h9.5v18H0z' clipRule='evenodd' />
        <path fill='#FFD600' fillRule='evenodd' d='M9.5 0h14.501v9h-14.5z' clipRule='evenodd' />
        <path fill='#DE2110' fillRule='evenodd' d='M9.501 9h14.5v9h-14.5z' clipRule='evenodd' />
      </g>
      <path
        fill='#DEE1E8'
