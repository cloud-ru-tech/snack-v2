...
const GhanaSVG = createStandaloneIcon({
  testId: '-ghana',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Ghana_svg__a)'>
        <mask id='Ghana_svg__b' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <path fill='#006B3F' d='M0 0h24v18H0z' />
        <path fill='#FCD116' d='M0 0h24v12H0z' />
        <path fill='#CE1126' d='M0 0h24v6H0z' />
        <path fill='#000' d='m12 6 1.95 6-5.104-3.709h6.304L10.05 12z' />
      </g>
      <path
        fill='#DEE1E8'
