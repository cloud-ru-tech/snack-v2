...
const JapanSVG = createStandaloneIcon({
  testId: '-japan',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Japan_svg__a)'>
        ...
        <path fill='#BC002D' d='M12.002 14.596a5.595 5.595 0 1 0 0-11.19 5.595 5.595 0 0 0 0 11.19' />
      </g>
      <path
        fill='#DEE1E8'
