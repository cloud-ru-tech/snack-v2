...
const ThailandSVG = createStandaloneIcon({
  testId: '-thailand',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Thailand_svg__a)'>
        <mask id='Thailand_svg__b' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <path fill='#F4F5F8' fillRule='evenodd' d='M0 0h24v18H0z' clipRule='evenodd' />
        <path fill='#2D2A4A' fillRule='evenodd' d='M0 6.094h24v6H0z' clipRule='evenodd' />
        <path fill='#A51931' fillRule='evenodd' d='M0 0h24v3.094H0zm0 15h24v3H0z' clipRule='evenodd' />
      </g>
      <path
        fill='#DEE1E8'
