...
const GuineaSVG = createStandaloneIcon({
  testId: '-guinea',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Guinea_svg__a)'>
        <mask id='Guinea_svg__b' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <path fill='red' fillRule='evenodd' d='M0 0h7.999v18H0z' clipRule='evenodd' />
        <path fill='#FF0' fillRule='evenodd' d='M7.999 0H16v18H8z' clipRule='evenodd' />
        <path fill='#090' fillRule='evenodd' d='M16.001 0H24v18h-7.999z' clipRule='evenodd' />
      </g>
      <path
        fill='#DEE1E8'
