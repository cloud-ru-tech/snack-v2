...
const VietnamSVG = createStandaloneIcon({
  testId: '-vietnam',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Vietnam_svg__a)'>
        <mask id='Vietnam_svg__c' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <g clipPath='url(#Vietnam_svg__b)'>
          <path fill='#DA251D' d='M24 0H0v18h24z' />
          <path fill='#FF0' d='m12 3.6-3.177 9.765 8.316-6.03H6.861l8.316 6.03z' />
        </g>
      </g>
      <path
        fill='#DEE1E8'
