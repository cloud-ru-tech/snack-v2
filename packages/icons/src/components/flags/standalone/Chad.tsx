...
const ChadSVG = createStandaloneIcon({
  testId: '-chad',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Chad_svg__a)'>
        <mask id='Chad_svg__b' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <path fill='#000067' fillRule='evenodd' d='M0 0h8.025v18H0z' clipRule='evenodd' />
        <path fill='red' fillRule='evenodd' d='M15.976 0H24v18h-8.025z' clipRule='evenodd' />
        <path fill='#FF0' fillRule='evenodd' d='M8.025 0h7.95v18h-7.95z' clipRule='evenodd' />
      </g>
      <path
        fill='#DEE1E8'
