...
const LatviaSVG = createStandaloneIcon({
  testId: '-latvia',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Latvia_svg__a)'>
        <mask id='Latvia_svg__c' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <g clipPath='url(#Latvia_svg__b)'>
          <path fill='#fff' d='M0 0h24v18H0z' />
          <path fill='#981E32' fillRule='evenodd' d='M0 10.8h24V18H0zM0 0h24v7.2H0z' clipRule='evenodd' />
        </g>
      </g>
      <path
        fill='#DEE1E8'
