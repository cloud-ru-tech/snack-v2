...
const EstoniaSVG = createStandaloneIcon({
  testId: '-estonia',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Estonia_svg__a)'>
        <mask id='Estonia_svg__c' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <g clipPath='url(#Estonia_svg__b)'>
          <path fill='#151515' d='M0 0h24v18H0z' />
          <path fill='#fff' fillRule='evenodd' d='M0 12h24v6H0z' clipRule='evenodd' />
          <path fill='#3A99FF' fillRule='evenodd' d='M0 0h24v6H0z' clipRule='evenodd' />
        </g>
      </g>
      <path
        fill='#DEE1E8'
