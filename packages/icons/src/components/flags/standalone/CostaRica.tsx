...
const CostaRicaSVG = createStandaloneIcon({
  testId: '-costa-rica',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Costa_Rica_svg__a)'>
        <mask id='Costa_Rica_svg__b' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <path fill='#0000B4' fillRule='evenodd' d='M0 0h24v18H0z' clipRule='evenodd' />
        <path fill='#fff' fillRule='evenodd' d='M0 2.828h24v12.086H0z' clipRule='evenodd' />
        <path fill='#D90000' fillRule='evenodd' d='M0 5.914h24v5.914H0z' clipRule='evenodd' />
      </g>
      <path
        fill='#DEE1E8'
        ...
        mask='url(#Costa_Rica_svg__b)'
      />
      <defs>
        <clipPath id='Costa_Rica_svg__a'>
