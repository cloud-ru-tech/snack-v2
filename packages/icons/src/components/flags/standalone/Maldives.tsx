...
const MaldivesSVG = createStandaloneIcon({
  testId: '-maldives',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Maldives_svg__a)'>
        <mask id='Maldives_svg__b' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <path fill='#D21034' d='M0 0h24v18H0z' />
        <path fill='#007E3A' d='M4.5 4.5h15v9h-15z' />
        <path
          fill='#fff'
          fillRule='evenodd'
          d='M13.688 11.947q-.274.053-.563.053a3 3 0 1 1 .563-5.947 3 3 0 0 0 0 5.894'
          clipRule='evenodd'
        />
      </g>
      <path
