...
const MauritiusSVG = createStandaloneIcon({
  testId: '-mauritius',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Mauritius_svg__a)'>
        <mask id='Mauritius_svg__b' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <path fill='#00A04D' fillRule='evenodd' d='M0 13.5h24V18H0z' clipRule='evenodd' />
        <path fill='#151F6D' fillRule='evenodd' d='M0 4.5h24V9H0z' clipRule='evenodd' />
        <path fill='#EE2737' fillRule='evenodd' d='M0 0h24v4.5H0z' clipRule='evenodd' />
        <path fill='#FFCD00' fillRule='evenodd' d='M0 9h24v4.5H0z' clipRule='evenodd' />
      </g>
      <path
        fill='#DEE1E8'
