...
const PolandSVG = createStandaloneIcon({
  testId: '-poland',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Poland_svg__a)'>
        <mask id='Poland_svg__b' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <path fill='#fff' fillRule='evenodd' d='M24 18H0V0h24z' clipRule='evenodd' />
        <path fill='#DC143C' fillRule='evenodd' d='M24 18H0V9h24z' clipRule='evenodd' />
      </g>
      <path
        fill='#DEE1E8'
