...
const CoteDIvoireSVG = createStandaloneIcon({
  testId: '-cote-d-ivoire',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  rootFill: 'none',
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Cote_dIvoire_svg__a)'>
        <mask id='Cote_dIvoire_svg__b' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <path fill='#009E60' d='M0 0h24v18H0z' />
        <path fill='#fff' d='M0 0h16v18H0z' />
        <path fill='#F77F00' d='M0 0h8v18H0z' />
      </g>
      <path
        fill='#DEE1E8'
        ...
        mask='url(#Cote_dIvoire_svg__b)'
      />
      <defs>
        <clipPath id='Cote_dIvoire_svg__a'>
