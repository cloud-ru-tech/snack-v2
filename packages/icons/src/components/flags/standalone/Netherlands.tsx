...
const NetherlandsSVG = createStandaloneIcon({
  testId: '-netherlands',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Netherlands_svg__a)'>
        <mask id='Netherlands_svg__b' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <path fill='#fff' d='M0 0h24v18H0z' />
        <path fill='#1E448D' fillRule='evenodd' d='M0 12h24v6H0z' clipRule='evenodd' />
        <path fill='#B01923' fillRule='evenodd' d='M0 0h24v6H0z' clipRule='evenodd' />
      </g>
      <path
        fill='#DEE1E8'
