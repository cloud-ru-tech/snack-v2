...
const UkraineSVG = createStandaloneIcon({
  testId: '-ukraine',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Ukraine_svg__a)'>
        <mask id='Ukraine_svg__b' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <path fill='gold' fillRule='evenodd' d='M0 0h24v18H0z' clipRule='evenodd' />
        <path fill='#0057B8' fillRule='evenodd' d='M0 0h24v9H0z' clipRule='evenodd' />
      </g>
      <path
        fill='#DEE1E8'
