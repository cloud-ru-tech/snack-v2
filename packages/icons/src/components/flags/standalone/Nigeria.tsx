...
const NigeriaSVG = createStandaloneIcon({
  testId: '-nigeria',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Nigeria_svg__a)'>
        <mask id='Nigeria_svg__b' fill='#fff'>
        ...
        <path fill='#008753' fillRule='evenodd' d='M15.998 0H24v18h-8.002zM0 0h7.999v18H0z' clipRule='evenodd' />
      </g>
      <path
        fill='#DEE1E8'
