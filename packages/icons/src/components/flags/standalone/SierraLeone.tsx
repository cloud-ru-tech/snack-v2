...
const SierraLeoneSVG = createStandaloneIcon({
  testId: '-sierra-leone',
  nativeWidth: 24,
  nativeHeight: 18,
  preserveColor: true,
  ...
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={18} fill='none'>
      <g clipPath='url(#Sierra_Leone_svg__a)'>
        <mask id='Sierra_Leone_svg__b' fill='#fff'>
          <path d='M0 2a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2z' />
        </mask>
        <path fill='#0000CD' fillRule='evenodd' d='M0 12.011h24V18H0z' clipRule='evenodd' />
        <path fill='#fff' fillRule='evenodd' d='M0 6.026h24v5.985H0z' clipRule='evenodd' />
        <path fill='#00CD00' fillRule='evenodd' d='M0 0h24v6.026H0z' clipRule='evenodd' />
      </g>
      <path
        fill='#DEE1E8'
        ...
        mask='url(#Sierra_Leone_svg__b)'
      />
      <defs>
        <clipPath id='Sierra_Leone_svg__a'>
