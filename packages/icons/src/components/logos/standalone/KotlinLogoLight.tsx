...
const KotlinLogoLightSVG = createStandaloneIcon({
  testId: '-kotlin-logo-light',
  nativeWidth: 24,
  nativeHeight: 24,
  preserveColor: true,
  rootFill: 'none',
  children: (
    <svg xmlns='http://www.w3.org/2000/svg' width={24} height={24} fill='none'>
      <g clipPath='url(#KotlinLogoLight_svg__a)'>
        <path fill='url(#KotlinLogoLight_svg__b)' d='m0 24 12.04-12.04L24 24z' />
        <path fill='url(#KotlinLogoLight_svg__c)' d='M0 0h12.04L0 13z' />
        <path fill='url(#KotlinLogoLight_svg__d)' d='M12.04 0 0 12.68V24l12.04-12.04L24 0z' />
      </g>
      <defs>
        <linearGradient
          id='KotlinLogoLight_svg__b'
          x1={6.384}
          x2={17.722}
          y1={29.605}
          y2={18.267}
        ...
        <clipPath id='KotlinLogoLight_svg__a'>
...
export default KotlinLogoLightSVG;
