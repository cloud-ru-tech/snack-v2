/**
 * Конфиг групп иконок. Каждая папка верхнего уровня в svgs/ — это группа.
 * Новые группы добавляются созданием папок в svgs/.
 */
...
/** Id группы для имени sprite-файла: snack-icons -> snack-icons, product/basic -> product-basic */
