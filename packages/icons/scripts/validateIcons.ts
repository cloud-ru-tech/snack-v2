...
import { validateIconSize, Validator } from './iconValidators';
import { getIconGroups, getGroupSourcePath } from './iconGroups';
...
const validators: Validator[] = [validateIconSize];
