...
import { defaultBaseConfig, defaultBrowserConfig, defaultNodeConfig } from '../../config/defaultConfig.js';
import { normalizeBrowserConfig, normalizeNodeConfig } from '../../config/normalizeConfig.js';
