...
export type BaseConfig = {
  ...
  /**
   * Наборы токенов (`<группа>/<набор>`), которые должны быть исключены из сборки
   * Например: ['04_brand/hrPortal'] — родительский слой, нужный только в Figma
   */
  excludeTokenSets?: string[];
  /**
