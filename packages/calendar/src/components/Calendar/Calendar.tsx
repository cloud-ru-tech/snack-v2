...
import { CSSProperties, ReactNode, RefObject, useCallback, useMemo } from 'react';

import { CALENDAR_MODE } from '../../constants';
import { CalendarBase } from '../../helperComponents';
...
export function Calendar(props: CalendarProps) {
  ...
  const value = useMemo(() => getNormalizedValue(props.value), [props.value]);
  const defaultValue = useMemo(() => getNormalizedValue(props.defaultValue), [props.defaultValue]);

  return (
    <CalendarBase {...rest} mode={mode} value={value} defaultValue={defaultValue} onChangeValue={changeValueHandler} />
  );
}
