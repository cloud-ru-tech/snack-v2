...
export type CalendarContextType = {
  ...
  value?: Range;
  firstNotDisableCell?: MutableRefObject<[number, number]>; // TODO: validate
...
const refStub: RefObject<HTMLButtonElement | null> = { current: null };

const listKeyboardNavigationRefStub: NonNullable<ListProps['keyboardNavigationRef']> = {
  current: { focusItem: stub },
};
...
export const CalendarContext = createContext<CalendarContextType>({
  ...
  viewShift: 0,
  firstNotDisableCell: firstNotDisableCellStub, // TODO: validate that is required
  setFocus: stub,
  setValue: stub,
  setViewMode: stub,
  showHolidays: false,
  ...
  hoursKeyboardNavigationRef: listKeyboardNavigationRefStub,
  minutesKeyboardNavigationRef: listKeyboardNavigationRefStub,
  secondsKeyboardNavigationRef: listKeyboardNavigationRefStub,
});
