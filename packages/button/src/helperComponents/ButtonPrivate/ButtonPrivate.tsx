...
import { APPEARANCE, APPEARANCE_TO_COLOR_MAP, HTML_TYPE, ICON_POSITION, TARGET } from '../../constants';
import { CommonButtonProps } from '../../types';
import styles from './styles.module.scss';
import { getChildren, getVariant } from './utils';

export type ButtonPrivateProps = CommonButtonProps & {
...
export const ButtonPrivate = forwardRef<HTMLButtonElement | HTMLAnchorElement, ButtonPrivateProps>(
  (
    ...
    const buttonProps = {
      ...
      'data-appearance': APPEARANCE_TO_COLOR_MAP[appearance] || appearance,
...
ButtonPrivate.displayName = 'ButtonPrivate';
