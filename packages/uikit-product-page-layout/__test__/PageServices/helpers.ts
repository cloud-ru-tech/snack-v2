...
export const PAGE_SERVICES_TEST_ID = TEST_IDS.pageServices.root;
...
export const PAGE_SERVICES_STORIES = {
  playground: {
...
// layoutType — единственная адаптивная ось PageServices (desktop / mobile).
export const PAGE_SERVICES_LAYOUTS = ['desktop', 'mobile'] as const;

export function buildStoryOptions(
  props?: Record<string, unknown>,
  ref: UikitStoryRef = PAGE_SERVICES_STORIES.playground,
  ...
  return {
    ...
    name: ref.name,
    story: ref.story,
    props: { 'data-test-id': PAGE_SERVICES_TEST_ID, ...props },
    globals,
  };
}
