...
export type CarouselProps = WithSupportProps<{
  ...
  /**
   * Кол-во отображаемых единовременно айтемов
   * @default 1
   */
  showItems?: number;
  /**
   * Сдвиг айтемов при смене 1 страницы
   * @default Math.trunc(show)
   */
  scrollBy?: number;
  /**
   * Время переключения 1 страницы (в s)
   * @default 0.4
   */
  transition?: number;
  /**
  ...
  autoSwipe?: number;
  /**
   * Минимальная длина в px для активации свайпа
   * @default 48
   */
  ...
  arrows?: boolean;
  /**
   * Использовать пагинацию для переключения страниц
   * @default true
   */
  pagination?: boolean;
  /**
   * Расстояние между айтемами
   * @default var(--dimension-2m)
   */
  gap?: string;
  /**
  ...
  /**
   * Управление видимостью стрелок: 'hover' — по ховеру, 'always' — всегда
   * @default 'hover'
   */
