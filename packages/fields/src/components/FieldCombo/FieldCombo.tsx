...
export type FieldComboProps = FieldComboDecoratorProps &
  Omit<InputPrivateProps, 'className' | 'value' | 'onChange'> &
  FieldComboSlotProps;

export const FieldCombo = forwardRef<HTMLInputElement, FieldComboProps>(function FieldCombo(
  {
    label = '',
    labelTooltip,
    caption,
  ...
  const shell = (
    <div
      ...
      data-test-id={innerTestIds?.shell ?? TEST_IDS.fieldComboShell}
      data-size={size}
