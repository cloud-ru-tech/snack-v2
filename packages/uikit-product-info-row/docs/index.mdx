...
| Узкий экран / comfort-раскладка той же матрицы Figma | `MobileInfoRow` или `AdaptiveInfoRow` с `layoutType={LAYOUT_TYPE.Comfort}` |
| Список полей с переключением compact / comfort | `AdaptiveInfoGroup` |
